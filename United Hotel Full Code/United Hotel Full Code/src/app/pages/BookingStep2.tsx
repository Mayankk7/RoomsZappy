        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_460px] gap-8">
          ...
          <div>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="bg-white rounded-2xl border border-[#eaeaea] p-8 mb-6">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="font-['Inter:Regular',sans-serif] text-[13px] text-[#6b7280]">
                      Optional - Let the hotel know if you have any special
                      requirements
                    </p>
                  </div>
                </div>
                ...
                <div className="mt-3 bg-[#fffbeb] border border-[#fbbf24]/20 rounded-lg p-3 flex items-start gap-2">
                  ...
                  <p className="font-['Inter:Regular',sans-serif] text-[13px] text-[#92400e]">
                    Special requests cannot be guaranteed but the hotel will do
              ...
              <div className="bg-linear-to-br from-[#fffbeb] to-[#fef3c7] border-2 border-[#fbbf24]/30 rounded-2xl p-6">
                  ...
                  <div>
                    ...
                    <ul className="space-y-2.5">
                      ...
                      <li className="flex items-start gap-3">
                        <CheckCircle2 className="w-4 h-4 text-[#f59e0b] shrink-0 mt-0.5" />
                        <span className="font-['Inter:Regular',sans-serif] text-[14px] text-[#92400e]">
                          A valid <strong>government-issued photo ID</strong>{" "}
                          and <strong>credit card</strong> are required at
                          check-in
                        </span>
                      </li>
                      <li className="flex items-start gap-3">
          ...
          <div>
            <div className="lg:sticky lg:top-24">
              ...
              {/* Security Badge */}
              <div className="bg-linear-to-br from-[#d1fae5] to-[#a7f3d0] rounded-2xl p-6 border border-[#86efac]">
                ...
                <p className="font-['Inter:Regular',sans-serif] text-[14px] text-[#065f46] leading-[22px]">
                  ...
                  information. Your data will never be shared with third
                  parties.
                </p>
              </div>
            </div>
